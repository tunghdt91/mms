...
class DoanVien extends CActiveRecord
{
	...
	public function attributeLabels()
	{
		return array(
			'id' => 'ID',
			'ma_doan_vien' => 'Ma Doan Vien',
			'ten' => 'Ten',
			'ho_ten_dem' => 'Ho Ten Dem',
			'bi_danh' => 'Bi Danh',
			'gioi_tinh' => 'Gioi Tinh',
			'ngay_sinh' => 'Ngay Sinh',
			'que_quan' => 'Que Quan',
			'ho_khau_thuong_tru' => 'Ho Khau Thuong Tru',
			'ho_khau_tam_tru' => 'Ho Khau Tam Tru',
			'email' => 'Email',
			'dien_thoai' => 'Dien Thoai',
			'dan_toc_id' => 'Dan Toc',
			'ton_giao_id' => 'Ton Giao',
			'thanh_phan_gia_dinh_xuat_than' => 'Thanh Phan Gia Dinh Xuat Than',
			'nghe_nghiep_id' => 'Nghe Nghiep',
			'mo_ta_cong_viec' => 'Mo Ta Cong Viec',
			'trinh_do_van_hoa' => 'Trinh Do Van Hoa',
			'bang_cap_1' => 'Bang Cap 1',
			'bang_cap_2' => 'Bang Cap 2',
			'ky_nang_ngoai_ngu_id' => 'Ky Nang Ngoai Ngu',
			'ky_nang_tin_hoc_id' => 'Ky Nang Tin Hoc',
			'tinh_trang_suc_khoe' => 'Tinh Trang Suc Khoe',
			'ngay_vao_doan' => 'Ngay Vao Doan',
			'danh_hieu_id' => 'Danh Hieu',
			'ly_luan_chinh_tri_id' => 'Ly Luan Chinh Tri',
			'ban_id' => 'Ban',
			'chuc_vu_doan_id' => 'Chuc Vu Doan',
