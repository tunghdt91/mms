...
/**
 * This is the model class for table "danh_hieu".
 *
 * The followings are the available columns in table 'danh_hieu':
 * @property integer $id
 * @property string $ten
...
class DanhHieu extends ActiveRecord
{
    ...
    public function relations()
    {
        ...
        return array(
            'doan_vien_s' => array(self::HAS_MANY, 'DoanVien', 'danh_hieu_id'),
        );
    }
