 ...
 *
 * The followings are the available columns in table 'ton_giao':
 * @property integer $id
 * @property string $ten
 ...
 */
class TonGiao extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return TonGiao the static model class
	 */
	...
	public function relations()
	{
		...
		return array(
			'doan_vien_s' => array(self::HAS_MANY, 'DoanVien', 'ton_giao_id'),
		);
	}
