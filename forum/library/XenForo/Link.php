...
class XenForo_Link
{
	...
	{
		self::$_canonicalLinkPrefix = self::convertUriToAbsoluteUri($linkPrefix);
	}
	...
	public static function getCanonicalLinkPrefix()
	{
		...
		{
			self::$_canonicalLinkPrefix = self::convertUriToAbsoluteUri(XenForo_Application::get('options')->boardUrl);
		}
