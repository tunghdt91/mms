...
$data['xf_user_field'] = "
	...
	VALUES
		...
		('msn', 'contact', 20, 'textbox', '', 'email', '', '', '', 0, ''),
		('icq', 'contact', 30, 'textbox', '', 'number', '', '', '', 0, ''),
		('yahoo', 'contact', 40, 'textbox', '', 'none', '', '', '', 0, ''),
		('skype', 'contact', 50, 'textbox', '', 'regex', '^[a-zA-Z0-9-_\.,]{3,30}$', '', '', 30, ''),
...
$data['xf_phrase'] = "
	...
	VALUES
		...
		(0, 'user_field_msn', 'Windows Live', 1, ''),
		(0, 'user_field_msn_desc', '', 0, ''),
...
$data['xf_bb_code_media_site'] = '
	...
	VALUES
		...
		(\'dailymotion\', \'Dailymotion\', \'http://www.dailymotion.com\', \'dailymotion.com/video/{$id:alphanum}_\', \'<iframe frameborder="0" width="500" height="300" src="http://www.dailymotion.com/embed/video/{$id}?width=500&hideInfos=1"></iframe>\', 0),
